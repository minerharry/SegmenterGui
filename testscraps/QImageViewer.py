...
from PyQt6.QtWidgets import QLabel, QSizePolicy, QScrollArea, QMessageBox, QMainWindow, QMenu, QFileDialog
...
class QImageViewer(QMainWindow):
    ...
    def createActions(self):
       ...
       # self.aboutQtAct = QAction("About &Qt", self, triggered=.aboutQt)
